...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> setApprove(Long id, boolean isApproved, Long approverId) {
        Map<String, Object> parameters = Map.of(
    ...
    public ResponseEntity<Object> getBookingsByItemOwner(Long requesterId, BookingState state, Integer from,
        ...
        return get("/owner?state={state}&from={from}&size={size}", requesterId, parameters);
    }
}
